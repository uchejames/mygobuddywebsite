...
function About() {
  ...
  <div>
      ...
      <div>
        ...
        <div className="p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
          <div className="flex justify-end mr-10">
            <img src="./src/assets/mission1.png" alt="Travel buddies" className="rounded-2xl object-cover w-[407px] h-[306px]"/>
          </div>
    ...
    {      /* adventure Section */}
      <section className="bg-[#ffffff] py-16 px-10 bg-[url('./src/assets/adventure.png')] bg-auto bg-center h-screen bg-no-repeat">
